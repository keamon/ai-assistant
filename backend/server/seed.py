    ...
    return {
        ...
        "issues": [
            {"id": "SSIM-101", "key": "SSIM-101", "project": "SSIM",
             "title": "Prepare Q2 payments performance pack for Northwind Retail review",
            ...
            {"id": "SSIM-104", "key": "SSIM-104", "project": "SSIM",
             "title": "Atlas Marketplace final pitch deck — risk & fraud lead",
            ...
            {"id": "SSIM-105", "key": "SSIM-105", "project": "SSIM",
             "title": "Brightline Financial pre-read pack (BSA/AML program, KYC flow, compliance DDQ)",
...
def _seed_salesforce(today: str) -> dict:
    ...
    return {
        "accounts": [
            {"id": "acc_northwind", "name": "Northwind Retail Group", "type": "Enterprise Merchant",
             "scale": "$12B TPV", "owner": "Sarah Chen", "status": "Active Client"},
            {"id": "acc_atlas", "name": "Atlas Marketplace", "type": "Enterprise Merchant",
             "scale": "$3B projected TPV", "owner": "Peter Walsh", "status": "Prospect — RFP Finalist"},
            {"id": "acc_brightline", "name": "Brightline Financial", "type": "BaaS Partner",
